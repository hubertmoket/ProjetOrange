...
<div class="container body-content">
                ...
                <nav class="navbar navbar-dark bg-dark navbar-expand-md">
                    <div class="container">
                        ...
                        <div class="navbar-collapse justify-content-between collapse" id="collapsing-navbar">
                            <ul class="navbar-nav">
                                <li class="nav-item"><a class="nav-link" href="creation.php">Creation</a></li>
                                <li class="nav-item active"><a class="nav-link" href="modif.php">Modif</a></li>
                                <li class="nav-item"><a class="nav-link" href="resil.php">Resil</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <div class="table-responsive col-md-12">
            <table id="myTable" class="table-bordered col-md-12" style="text-align:center">
                <thead>
                  <tr>
                    <th colspan=3></th>
                    <th class="table-light" colspan=2>Souhait délégation</th>
    ...
    <div class="row bottom-buffer">
        ...
        <div class="col-md-1">
                <button type="button" class="btn btn-primary" onclick="addData(dataTestModif, 'modif')">DATA</button>
        </div>  
        <div class="col-md-5"></div>
    </div>
